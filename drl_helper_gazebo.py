...
class DRL_helper_gazebo(Node):
    def __init__(self, stage):
        super().__init__('drl_helper_gazebo')
...
def main(args=sys.argv[1]):
    ...
    drl_helper_gazebo = DRL_helper_gazebo(args)
    rclpy.spin(drl_helper_gazebo)

    drl_helper_gazebo.destroy()
    rclpy.shutdown()
